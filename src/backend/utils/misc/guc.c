 ...
 *
 *
 * Copyright (c) 2021, Halo Tech Co,.Ltd.
...
bool		halo_mysql_listener_on = false;	/* enable MySQL listener */
...
static struct config_bool ConfigureNamesBool[] =
{
...

	{
        ...
        &halo_mysql_explicit_defaults_for_timestamp,
        false,
        NULL, NULL, NULL
    },
	{
        {"mysql.auto_rollback_tx_on_error", PGC_POSTMASTER, CUSTOM_OPTIONS,
            gettext_noop("Sets the mysql auto_rollback_tx_on_error."),
            NULL
        },
        &halo_mysql_auto_rollback_tx_on_error,
        false,
        NULL, NULL, NULL
    },
	{
        {"mysql.support_multiple_table_update", PGC_POSTMASTER, CUSTOM_OPTIONS,
            gettext_noop("Sets the mysql support_multiple_table_update."),
            NULL
        },
        &halo_mysql_support_multiple_table_update,
        true,
        NULL, NULL, NULL
    },
...
static struct config_int ConfigureNamesInt[] =
{
	...
	{
        {"mysql.column_name_case_control", PGC_POSTMASTER, CUSTOM_OPTIONS,
            gettext_noop("Sets the mysql column_name_case_control."),
            NULL
        },
        &halo_mysql_column_name_case_control,
        0, 0, 3,
        NULL, NULL, NULL
    },
    {
        {"mysql.max_allowed_packet", PGC_USERSET, CUSTOM_OPTIONS,
            gettext_noop("Sets max allowed packet the server can receive."),
            NULL,
            GUC_UNIT_BYTE
        },
        &halo_mysql_max_allowed_packet,
        /* For Halo-MySQL, max_allowed_packet size is 512MB */
        67108864, 1024, 1073741824,     /* mysql客户端可能会要求1GB */
        NULL, NULL, NULL
    },
...
static struct config_string ConfigureNamesString[] =
{
    ...
    {
        {"mysql.halo_mysql_version", PGC_POSTMASTER, CUSTOM_OPTIONS,
...
static struct config_enum ConfigureNamesEnum[] =
{
	...
	{
		{"standard_parserengine_auxiliary", PGC_USERSET, CUSTOM_OPTIONS,
			gettext_noop("Sets the parserengine if need standard parserengine auxiliary."),
			NULL,
			GUC_SUPERUSER_ONLY
		},
		&standard_parserengine_auxiliary,
		STANDARDARD_PARSERENGINE_AUXILIARY_ON, standard_parserengine_auxiliary_options,
		NULL, NULL, NULL
	},
...
assign_session_replication_role(int newval, void *extra)
{
	...
	{
		elog(DEBUG1, "assign_session_replication_role: invalidate all cached plans.");
		ResetPlanCache();
	}
