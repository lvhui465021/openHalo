...
bytea2int8_internal(bytea *vlena)
{
    ...
    /* Let int8in handle validation - it provides proper error messages */
...
mys_bytea2int4(PG_FUNCTION_ARGS)
{
    ...
    /* Let int4in handle validation - it provides proper error messages */
...
mys_bytea2int2(PG_FUNCTION_ARGS)
{
    ...
    /* Let int2in handle validation - it provides proper error messages */
...
convertParameterToInt8(Oid parmType, Datum parm)
{
    ...
    else if (parmType == TEXTOID)
    {
        ...
        resultTemp = pg_strtoint64(parmVal);
