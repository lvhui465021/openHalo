 ...
 *
 * mys_parse_oper.c
 *    MySQL-specific operator resolution.
 *
 * Portions Copyright (c) 2026, HaloLab / openHalo Contributors
 *
 * src/backend/parser/mysql/mys_parse_oper.c
 *
 *-------------------------------------------------------------------------
 */
...
//											Oid *operOid);
static const char *mys_op_signature_string(List *op, char oprkind,
									   Oid arg1, Oid arg2);
 ...
 */
static const char *
mys_op_signature_string(List *op, char oprkind, Oid arg1, Oid arg2)
{
...
//						mys_op_signature_string(op, oprkind, arg1, arg2)),
		...
		ereport(ERROR,
				(errcode(ERRCODE_UNDEFINED_FUNCTION),
				 errmsg("operator is only a shell: %s",
						mys_op_signature_string(opname,
											opform->oprkind,
											opform->oprleft,
											opform->oprright)),
				 parser_errposition(pstate, location)));
