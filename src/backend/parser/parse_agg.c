...
/*
 * standard_transformAggregateCall -
 ...
 */
void
standard_transformAggregateCall(ParseState *pstate, Aggref *agg,
...
/*
 * standard_transformGroupingFunc
 ...
 */
Node *
standard_transformGroupingFunc(ParseState *pstate, GroupingFunc *p)
{
	ListCell   *lc;
	List	   *args = p->args;
...
/*
 * standard_transformWindowFuncCall -
 ...
 */
void
standard_transformWindowFuncCall(ParseState *pstate, WindowFunc *wfunc,
						WindowDef *windef)
{
	const char *err;
	bool		errkind;
