 ...
 * ---------------------------------------------------------------------------------------
 */
#ifndef OPENHALO_CONTRIB_NGRAM_TS_ZH_NGRAM_H
#define OPENHALO_CONTRIB_NGRAM_TS_ZH_NGRAM_H
 ...
 */
static inline uint8 gbk_dword_parser(const char* ch)
{
 ...
 */
static inline uint8 utf8_parser(const char* ch, uint8* len)
{
